...
%%%%%%%%%%% jump to tables/master.tex
%%%---------- open: tables/master.tex
...
\label{table:master}
\end{table}
%%%---------- close: tables/master.tex

%%%%%%%%%%% jump to graphs/all_superglue.tex
%%%---------- open: graphs/all_superglue.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_superglue.tex

%%%%%%%%%%% jump to graphs/all_sat.tex
%%%---------- open: graphs/all_sat.tex
\begin{figure}
\centering
...
%%%---------- close: graphs/all_winograd.tex

%%%%%%%%%%% jump to graphs/all_arithmetic.tex
%%%---------- open: graphs/all_arithmetic.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_arithmetic.tex

%%%%%%%%%%% jump to graphs/all_cloze_and_completion.tex
%%%---------- open: graphs/all_cloze_and_completion.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_cloze_and_completion.tex

%%%%%%%%%%% jump to graphs/all_common_sense.tex
%%%---------- open: graphs/all_common_sense.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_common_sense.tex

%%%%%%%%%%% jump to graphs/all_qas.tex
%%%---------- open: graphs/all_qas.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\label{graph:all_qa}
\end{figure}%%%---------- close: graphs/all_qas.tex

%%%%%%%%%%% jump to graphs/all_reading_comprehension.tex
%%%---------- open: graphs/all_reading_comprehension.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_reading_comprehension.tex

%%%%%%%%%%% jump to graphs/all_anli.tex
%%%---------- open: graphs/all_anli.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_anli.tex


%%%%%%%%%%% jump to graphs/all_scramble.tex
%%%---------- open: graphs/all_scramble.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_scramble.tex

%%%%%%%%%%% jump to graphs/all_translation.tex
%%%---------- open: graphs/all_translation.tex
\begin{figure}
\begin{tabular}{lll}
\toprule
...
\end{figure}%%%---------- close: graphs/all_translation.tex
